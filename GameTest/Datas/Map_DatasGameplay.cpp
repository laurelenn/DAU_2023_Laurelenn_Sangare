...
{
    GameplayDatasMap(Monster1, Floor_Level0, .0f, 200.0f),
    GameplayDatasMap(Monster1, Floor_Level0, .0f, 900.0f)
};


const std::vector<GameplayDatasMap> Map_DatasGameplay::m_LD_Easy_2 =
{
    GameplayDatasMap(Monster1, Floor_Level0, .0f, 600.0f),
    GameplayDatasMap(Monster1, Floor_Level0, .0f, 1000.0f)
};
